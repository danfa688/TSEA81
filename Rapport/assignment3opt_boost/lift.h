...
/* Number of iterations for each person */
...
typedef struct
{
    ...
    pthread_cond_t cond_enter_exit;

    pthread_cond_t cond_new_floor;

    pthread_cond_t cond_floor[N_FLOORS];


    /* semahore, to indicate that a person has been created */ 
    sem_t sem;  
    sem_t sem_done; //Semaphore to indicate person is done
