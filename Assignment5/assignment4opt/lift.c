...
/* evacuate_passengers: checks if any passengers wants to leave the lift and
	then (maybe) sends them a message that their route is done */
/*
void evacuate_passengers(struct lift_msg *reply, lift_type Lift)
{
    int i;
    for(i = 0; i < MAX_N_PASSENGERS; i++){
